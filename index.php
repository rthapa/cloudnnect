...
<html lang="en">
		...
		<script>
			...
			function login(){
				...
				if(e == "" || p == ""){
					...
					window.location.replace("login_retry.php");
				} else {
	...
	<body>
		<nav class="navigation-wrapper non-fixed"> <!--Navigation-->
			...
			<section class="main">
				...
				<form class="form-login clearfix" id="loginform" onsubmit="return false;">
				    <p>
				        ...
				        <input type="password" id="password" onfocus="emptyElement('status')" maxlength="100" placeholder="Password"> 
				    </p>
				    ...
				    <p id="status"></p>
				    <h4><a href="forgot_pass.php">forgot your password?</a></h4>
	...
	<div class="offerBanner">		<!--Second Banner Wrapper-->
		...
		<div class="cloud-promo">
			...
			<p>Download what other people are sharing or upload and contribute to the cloudnnect community.</p>
		</div>
		
		<div class="cloud-promo">
			<img src="Images/cloudHobby.png">
			<h4>Your cloud</h4>
			<p>World needs a file sharing community. Upload today and contribute to the cloudnnect community.</p>
		</div>
		
		<div class="cloud-promo">
			<img src="Images/cloudPhone.png">
			<h4>Cloud access</h4>
			<p>Cloudnnect will be soon available for phones and tablets.</p>
		</div>
